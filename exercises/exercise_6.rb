...
@store3.employees.create(first_name: "Russell", last_name: "Oliver", hourly_rate: 420)
@store3.employees.create(first_name: "Frankie", last_name: "Engebretson", hourly_rate: 420)
@store3.employees.create(first_name: "Sophie", last_name: "Herda", hourly_rate: 420)
@store3.employees.create(first_name: "Katie", last_name: "Oliver", hourly_rate: 420)